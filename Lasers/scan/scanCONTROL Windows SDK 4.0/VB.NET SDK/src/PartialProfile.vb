...
Namespace VB
    ...
    Public Class VBscanCNONTROLSample
        ...
        Shared Sub scanCONTROL_Sample()
            ...
            If (bOK) Then
                Console.WriteLine(Environment.NewLine & "----- Poll Pure Profile from scanCONTROL via Ethernet -----" & Environment.NewLine)
                bOK = Partial_Profile_Pure()
            End If

            If (bOK) Then
                Console.WriteLine(Environment.NewLine & "----- Poll Quarter Profile from scanCONTROL via Ethernet -----" & Environment.NewLine)
                bOK = Partial_Profile_Quarter()
            End If
        ...
        Shared Function Partial_Profile_Pure()
            ...
            Dim tPartialProfile As CLLTI.TPartialProfile
            ...
            Dim abyProfileBuffer(tPartialProfile.nPointDataWidth * tPartialProfile.nPointCount - 1) As Byte
            Dim abyTimestamp(16) As Byte

            'Set the partial profile setting
            ...
            iRetValue = CLLTI.GetActualProfile(hLLT, abyProfileBuffer, abyProfileBuffer.GetLength(0), CLLTI.TProfileConfig.PARTIAL_PROFILE, uiLostProfiles)
            ...
            Console.WriteLine("Converting of profile ")
            iRetValue = CLLTI.ConvertPartProfile2Values(hLLT, abyProfileBuffer, tPartialProfile, tscanCONTROLType, 0, 1, Nothing, Nothing, Nothing, adValueX, adValueZ, Nothing, Nothing)
            ...
            Buffer.BlockCopy(abyProfileBuffer, tPartialProfile.nPointCount * tPartialProfile.nPointDataWidth - 16, abyTimestamp, 0, 16)
        ...
        Shared Function Partial_Profile_Quarter()
            ...
            tPartialProfile.nStartPointData = 0                 ' data offset
            tPartialProfile.nPointCount = uiResolution       ' transmit  the full resolution
            tPartialProfile.nPointDataWidth = 16               ' 16 bytes -> X und Z and meta information
