...
Namespace VB
    ...
    Public Class VBscanCNONTROLSample
        ...
        ' Evalute received profiles 
        Shared Sub GetProfiles_Poll()
            ...
            ' Allocate buffer for multiple profile
            Dim abyFullProfileBuffer(uiResolution * 64 * uiNeededProfileCount - 1) As Byte
            ...
            Do While (uiReceivedProfileCount < uiNeededProfileCount)
            ...
            For iProfile As Integer = 0 To uiNeededProfileCount - 1
                Buffer.BlockCopy(abyFullProfileBuffer, ((iProfile + 1) * 64 * uiResolution) - 16, abyTimestamp, 0, 16)
