...
void
CDllLoader::Reload(bool* pLoadError /*=NULL*/)
{
  // unload the dll
  Unload();
  // load the dll
...
void
CDllLoader::Load(const char* Dll, bool* pLoadError /*=NULL*/)
{
  // load the dll
...
FARPROC
CDllLoader::GetFunction(const char* FuncName)
{
  if (m_hDLL)
  {
...
void
CDllLoader::HandleFatalError(const char* Dll)
{
