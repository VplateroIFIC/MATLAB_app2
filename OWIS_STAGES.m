...
classdef OWIS_STAGES
    ...
    methods
        ...
        function this = INIT(this)
            ...
            for i=1:3
                ...
                if error == 0           %There are no error in all axis
                    ...
                    error = (calllib('ps90','PS90_GetReadError' , this.Index));   %%Check error in reading position
                    showError1 (error);
                else
                    fprintf('Error %s \n', error);
                end
        ...
        function MotorEnableAll(this)
            for i=1:3
                this.MotorEnable(this,this.Axis(i));
            end
        end
        ...
        function  MoveBy(this,axis,delta,velocity)
            ...
            this.pos_vel(axis) = velocity;
            this.TargetMode(axis) = this.relative;
            error = (calllib('ps90', 'PS90_SetPosFEx', this.Index, this.xAxis, this.pos_vel(axis)) ~= 0 );
            this.showError(error);
