        ...
        long long int output = 0;
         output = serialPort.write(enq);
            ...
            if (readData.endsWith("\x06"))
              {      endRead=1;
                qDebug() << "Glue dispenser Ready.";}
            if (ite==50)
                qDebug() << "Impossible connect to Glue dispenser.";
            }
...
bool glue_dispenser::dispenser_init()
...
bool glue_dispenser::dispenser_mode()
{
...
bool glue_dispenser::dispenser_pressure()
{
...
bool glue_dispenser::dispenser_pressureUnits()
{
QByteArray newUnits;
...
bool glue_dispenser::dispenser_time()
{
...
bool glue_dispenser::dispenser_vacuum()
{
...
bool glue_dispenser::RS232V(QByteArray command)
{
...
QByteArray glue_dispenser::RS232V_fb(QByteArray command)
...
bool glue_dispenser::dispenseCycle()
...
//bool glue_dispenser::patternLine()
