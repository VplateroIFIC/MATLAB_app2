...
classdef PetalCoordinates < handle
  ...
  methods
      function obj = PetalCoordinates()
         ...
         RadiusInt={384.050, 489.373, 575.144, 638.159, 756.451, 867.012};
         RadiusCenter={438.614, 534.639, 609.405, 697.899, 812.471, 918.749};
         RadiusExt={488.873, 574.644, 637.659, 755.951, 866.512, 968.235};
         angle={0.000000, 0.000000, 0.000000, 0.050397, 0.050377, 0.050381};
         
         obj.sensor_data = struct('Ri',RadiusInt,'R',RadiusCenter,'Ro',RadiusExt,'angle',angle);
      ...
      function read_fiducials(obj, fname)
         ...
         %
         fprintf('Reading fiducials from %s\n', fname);
...
%          inv=inverse(obj.M.M);
         ...
         for iring = 1:6
            ...
            for isensor = 1:nsensor
               ...
               angle =angle+obj.petal_rotation;
